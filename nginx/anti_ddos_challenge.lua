...
local title = host .. [[ | DDoS Flood Protection and Firewall]]
...
local ddos_credits = [[
    ...
    <span class="badge badge-info">Copyright &copy; DDoS Team UEM <script>document.write(new Date().getFullYear());</script>
    </div>
]]
